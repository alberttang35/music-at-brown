...
export const mockWeekly1: EventEntry[] = [
  {
    artist: mockArtists1[0], //"Taylor Swift",
    venue: "GovBall",
    image:
  ...
  {
    artist: mockArtists1[1], //"Jay Park",
    venue: "Coachella",
    image:
  ...
  {
    artist: mockArtists1[2], //"Post Malone",
    venue: "HITC",
    image:
  ...
  {
    artist: mockArtists1[3], //"Taylor Swift",
    venue: "GovBall",
    image:
      "https://assets.teenvogue.com/photos/64f0a106a683b28e919ea05c/16:9/w_4649,h_2615,c_limit/GettyImages-1604947670.jpg",
    date: "10/1/2023",
  ...
  {
    artist: mockArtists1[4], //"Jay Park",
    venue: "Coachella",
    image:
      "https://www.billboard.com/wp-content/uploads/media/jay-park-performance-2016-billboard-650.jpg?w=650",
    date: "11/2/2024",
  ...
  {
    artist: mockArtists1[5], //"Post Malone",
    venue: "HITC",
    image:
      "https://i.guim.co.uk/img/media/77d56571e0e02c5da16ee6c15dc9926103df8717/0_0_6720_4032/master/6720.jpg?width=465&dpr=1&s=none",
    date: "1/2/2024",
